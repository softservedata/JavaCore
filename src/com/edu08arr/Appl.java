...
public class Appl {
    ...
    public static void main(String[] args) {
        ...
        // Print Array
        System.out.println("monthDays.length = " + monthDays); // Invalid Solution // monthDays.toString() from Object
        System.out.println("monthDays = " + Arrays.toString(monthDays)); // Ok
        // Compare
        System.out.println("arays.equals(monthDays, monthDays3) = " + Arrays.equals(monthDays, monthDays3));
        //
        ...
        System.out.println("manual isEqual = " + isEqual);
        //
        System.out.println("\n-1. for (int i=0; ...)");
